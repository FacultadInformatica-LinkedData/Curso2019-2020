...
public class Task07
{
	...
	{
		String file = "resources/example6.rdf";
		...
		InputStream inputInf = FileManager.get().open(file);
		modelInf.read(inputInf,null);
        ...
        ExtendedIterator subCsInf = personInf.listSubClasses();

        while(subCsInf.hasNext()){
            OntClass subCInf = (OntClass) subCsInf.next();
            System.out.println("Subclass of Person: " + subCInf.getURI());
        }
	}
}