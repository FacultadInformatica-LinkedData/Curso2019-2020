...
import static upm.oeg.wsld.jena.Task02.ns;
...
public class Task06
{
	...
	public static String foafKnowsURI = foafNS+"knows";
        public static String foafWorksInURI = foafNS+"worksIn";
	...
	public static void main(String args[])
	{
		...
		// ** TASK 6.3: Create a new property named "worksIn" **
                ...
                Property wksin = model.createProperty(foafWorksInURI);
		...
		JS.addLiteral(VCARD.FN,"Jane Smith");
                JS.addLiteral(VCARD.Given,"Jane");
                JS.addLiteral(VCARD.Family,"Smith");
