...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		Individual janesmith = model.getOntClass(ns+"Researcher").createIndividual(ns+"Jane Smith");
		...
		model.getIndividual(ns+"Jane Smith").addProperty(model.getProperty(ns+"worksIn"), upm);
