...
public class Task07
{
	...
	public static void main(String args[])
	{
		...
		ExtendedIterator instancias = mod.getOntClass(ns + "Person").listInstances();
		ExtendedIterator subClases = mod.getOntClass(ns + "Person").listSubClasses();
		...
		while (subClases.hasNext()){
			OntClass subCl = (OntClass) subClases.next();
