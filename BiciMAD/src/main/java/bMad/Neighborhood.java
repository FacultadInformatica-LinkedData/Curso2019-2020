...
public class Neighborhood {
    ...
    public Neighborhood() {
        ...
        this.neighborhoods.put("LAS_ACACIAS", "Q3319190");
        this.neighborhoods.put("JERÓNIMOS", "Q10306766");
        this.neighborhoods.put("IBIZA", "Q15249910");
        this.neighborhoods.put("NIÑO_JESÚS", "Q3773746");
        ...
        this.neighborhoods.put("CASA_DE_CAMPO", "Q16302441");
        this.neighborhoods.put("GAZTAMBIDE", "Q10288587");
        this.neighborhoods.put("PALOS_DE_MOGUER", "Q521009");
        this.neighborhoods.put("ATOCHA", "Q3814594");
        this.neighborhoods.put("TRAFALGAR", "Q10384027");
        this.neighborhoods.put("RÍOS_ROSAS", "Q10366270");
        this.neighborhoods.put("CUATRO_CAMINOS", "Q5824684");
        this.neighborhoods.put("EL_VISO", "Q4778");
        this.neighborhoods.put("LISTA", "Q4779");
        this.neighborhoods.put("CASTILLEJOS", "Q11913212");
        this.neighborhoods.put("NUEVA_ESPAÑA", "Q10338128");
        this.neighborhoods.put("HISPANOAMÉRICA", "Q3814573");
        this.neighborhoods.put("LAS_DELICIAS", "Q3773736");
        this.neighborhoods.put("LA_CHOPERA", "Q3773750");
